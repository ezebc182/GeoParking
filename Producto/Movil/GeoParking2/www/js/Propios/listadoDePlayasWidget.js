$.widget("geoparking.listadoPlayasWidget", {
    ...
    _crearEventoClickAPlaya: function (playa) {
        ...
        var eventoClick = function () {
            ...
            widget._guardarPlayaConsultada(playa, widget.options.cantidadHistorial);
    ...
    */
    ...
    _guardarPlayaConsultada: function (playa, cantidad) {
        var widget = this;
        ...
        if (arrayActual === null) {
            ...
            if (cantidadAlmacenadas < cantidad) {
                var estaRepetido = widget._verificarQueExistePlayaEnArray(playa, arrayActual);
    ...
    _crearEstructuraHistorial: function () {
        var widget = this;
