...
var divEstadisticaHistorica = '<div class="panel panel-default"><div class="panel-heading"><div class="row"><div class="col-lg-1"><h3 class="panel-title">Historico</h3></div><div class="col-lg-3"><div class="col-lg-6"><label class="control-label pull-right">Buscar Por:</label></div><div class="col-lg-6"><div class="bfh-selectbox" data-name="ddlBuscarPor"><div data-value="1">Playa</div><div data-value="2">Zona</div></div></div></div><div class="col-lg-3"><div class="col-lg-3"><label class="control-label">Desde:</label></div><div class="col-lg-9 pul-left"><div class="bfh-datepicker" data-placeholder="Fecha Desde" data-min="01/15/2013" data-max="today"></div></div></div><div class="col-lg-3"><div class="col-lg-3"><label class="control-label">Hasta:</label></div><div class="col-lg-9 pull-left"><div class="bfh-datepicker" data-placeholder="Fecha Hasta" data-min="01/15/2013" data-max="today"></div></div></div><div class="col-lg-2"><div class="pull-left"><button class="btn btn-success" type="button"><span class="fa fa-search"> Buscar</span></button></div><div class="pull-right"><i id="minMax" class="fa fa-square-o fa-lg"></i></div></div></div></div><div class="panel-body" style="display:none;"><div id="divFiltros" class="col-lg-4" ><div class="form-group col-lg-12"><div class="col-lg-3"  style="padding-left:0px;"><label class="form-label">Zonas: </label></div><div class="col-lg-9"><div class="bfh-selectbox" data-name="ddlZonas"></div></div></div><div class="form-group col-lg-12"><div class="col-lg-3"  style="padding-left:0px;"><label class="form-label">Playas: </label></div><div class="col-lg-9"><div class="bfh-selectbox" data-name="ddlPlayas"></div></div></div><div class="form-group col-lg-12"><div class="col-lg-3" style="padding-left:0px;"><label class="form-label">Tipo de playa:</label></div><div class="col-lg-9"><div class="bfh-selectbox" data-name="ddlTipoPlaya"></div></div></div><div class="form-group col-lg-12"><div class="col-lg-3" style="padding-left:0px;"><label class="form-label">Tipo de vehiculo:</label></div><div class="col-lg-9"><div class="bfh-selectbox" data-name="ddlTipoVehiculo"></div></div></div><div id="divEstadistica" data-value=""><div class="pull-left"><button class="glyphicon glyphicon-chevron-left" type="button" onclick="menuFiltros(this)"></button></div><div></div></div>';