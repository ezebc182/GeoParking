<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Playa.aspx.cs" Inherits="Web.Playa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <link type="text/css" href="./Styles/bootstrapValidator.min.css" rel="stylesheet" />
...
<asp:Content ID="Content4" ContentPlaceHolderID="helpContent" runat="server">
    <!-- Modal Ayuda-->
    <div class="modal fade" id="ayudaABMC" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="panel-group" id="accordion">
                        <div class="panel panel-success">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <span class="indicator glyphicon glyphicon-ok pull-left"></span><a style="text-decoration: none;"
                                        class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#ayudaRegistrarPlaya">
                                        &nbsp;&nbsp; Registrar
                        ...
                        <div class="panel panel-warning">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <span class="indicator glyphicon glyphicon-pencil pull-left"></span><a style="text-decoration: none;"
                                        class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#ayudaModificarPlaya">
                                        &nbsp;&nbsp; Modificar
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <span class="indicator glyphicon glyphicon-search pull-left"></span><a style="text-decoration: none;"
                                        class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#ayudaConsultarPlaya">
                                        &nbsp;&nbsp; Consultar
                                    </a><i class="indicator glyphicon glyphicon-chevron-up pull-right"></i>
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    ...
                                    <a style="text-decoration: none;" class="accordion-toggle" data-toggle="collapse"
                                        data-parent="#accordion" href="#ayudaEliminarPlaya">&nbsp;&nbsp; Eliminar
                                    </a><i class="indicator glyphicon glyphicon-chevron-up pull-right"></i>
                ...
                <div class="modal-footer">
                    <button type="reset" id="btnCerrar" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="acercaDe" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span class="glyphicon glyphicon-earphone">content</span>
                    <h6>0351 - XXXXXX</h6>
                </div>
                <div class="modal-footer">
        ...
        <div class="modal-dialog  modal-lg ">
            <div class=" modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div runat="server" id="divModal" class="form-horizontal" >
                        <ul class="nav nav-tabs" id="myTab">
                            <li runat="server" id="tabDatosGrales" class="active"><a href="#datosGrales" data-toggle="tab">
                                1. Datos Generales</a></li>
                            <li runat="server" id="tabHorarios"><a href="#horarios" data-toggle="tab">2. Horarios</a>
                            </li>
                            <li runat="server" id="tabPrecios"><a href="#precios" data-toggle="tab">3. Precios</a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" style="margin: 20px;">
                            ...
                            <div class="tab-pane fade active in" id="datosGrales">
                                ...
                                <asp:UpdatePanel runat="server" ID="upDatosGrales" >
                                    <ContentTemplate>
                                        ...
                                        <form id="formulario1" data-role="form" data-bv-message="El valor es requerido" data-bv-feedbackicons-valid="glyphicon glyphicon-ok"
                                            data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh"><%-- data-bv-message="El valor es requerido" data-bv-feedbackicons-valid="glyphicon glyphicon-ok"
                                            ...
                                            <div class="form-group " id="nombrePlaya">
                                                ...
                                                <div class="col-sm-10 col-md-10 col-lg-10 col-md-10 col-lg-10">
                                                    <asp:TextBox runat="server" CssClass="form-control "  ID="txtNombre" /><%-- data-bv-notempty="true"
                                                        data-bv-notempty-message="El nombre es requerido."--%>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="txtTelefono" class="col-sm-2 col-md-2 col-lg-2 col-md-2 col-lg-2 control-label">
                                                    Telefono</label>
                                                <div class="col-sm-3 col-md-3 col-lg-3">
                                                    <asp:TextBox runat="server" CssClass="form-control" type="tel" pattern="\b\d{3,5}[-.]?\d{3}[-.]?\d*\b"  ID="txtTelefono"  /><%-- data-bv-notempty="true"
                                                        data-bv-notempty-message="El teléfono es requerido" data-bv-regexp="true" data-bv-regexp-regexp="\b\d{3,5}[-.]?\d{3}[-.]?\d*\b"
                                                        data-bv-regexp-message="Ingrese un número telefónico correcto." />--%>
                                                </div>
                                                <label for="txtMail" class="col-sm-2 col-md-2 col-lg-2 control-label">Email</label>
                                                <div class="col-sm-5 col-md-5 col-lg-5">
                                                    <asp:TextBox runat="server" type="email" name="email" CssClass="form-control" ID="txtMail" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$"  />
                                ...
                                <div class="form-group ">
                                    <servicios:servicios runat="server" ID="ucServicios" OnErrorHandler="MostrarErrorServicio">
                                    </servicios:servicios>
                                </div>

                                <div class="form-group">
                                    <domicilios:domicilios runat="server" ID="ucDomicilios" OnErrorHandler="MostrarErrorDomicilio">
                                    </domicilios:domicilios>
                                    <div class="col-md-2 form-group pull-right">
                                        <button class="btn btn-primary pull-left disabled " id="btnPaso1_1"><span class='glyphicon glyphicon-chevron-left'>
                                        </span></button>
                                        <button class="btn btn-primary pull-right" id="btnPaso1_2" data-toggle="tab" data-target="#horarios"
                                            onclick="javascript:abrirTab(this.id)" ><span class='glyphicon glyphicon-chevron-right'>
                                            </span></button>
                                    </div>
                            ...
                            <div class="tab-pane" id="horarios">
                                <div class="form-group ">
                                    <horarios:horarios runat="server" ID="ucHorarios" OnErrorHandler="MostrarErrorHorario">
                                    </horarios:horarios>
                                    <div class="col-md-2 form-group pull-right">
                                        <a href="#" class="btn btn-primary pull-left" id="btnPaso2_1" data-toggle="tab" data-target="#datosGrales"
                                            onclick="javascript:abrirTab(this.id)" runat="server" aria-="True"><span class='glyphicon glyphicon-chevron-left'>
                                            </span></a>
                                        <a href="#" class="btn btn-primary pull-right" id="btnPaso2_3" data-toggle="tab"
                                            data-target="#precios" onclick="javascript:abrirTab(this.id)"><span class='glyphicon glyphicon-chevron-right'>
                                            </span></a>
                            ...
                            <div class="tab-pane" id="precios">
                                <div class="form-group ">
                                    <precios:precios runat="server" ID="ucPrecios" OnErrorHandler="MostrarErrorPrecio">
                                    </precios:precios>
                                    <div class="col-md-2 form-group pull-right">
                                        <a href="#" class="btn btn-primary pull-left" id="btnPaso3_2" data-toggle="tab" data-target="#horarios"
                                            onclick="javascript:abrirTab(this.id)"><span class='glyphicon glyphicon-chevron-left'>
                                            </span></a>
                                        <a href="#" class="btn btn-primary pull-right disabled" id="btnPaso3_3"><span class='glyphicon glyphicon-chevron-right'>
                                        </span></a>
                                    </div>
                ...
                <div class="modal-footer">
                    <asp:UpdatePanel runat="server" ID="upBotones">
                        <ContentTemplate>
                            <asp:Button ID="btnCancelar" runat="server" CssClass="btn btn-lg" OnClick="btnCancelar_Click"
                                data-dismiss="modal" Text="Cancelar"></asp:Button>
                            <asp:Button ID="btnGuardar" runat="server" CssClass="btn disabled btn-success btn-lg"
                                OnClick="btnGuardar_Click" Text="Guardar"></asp:Button>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                ...
                <div class="container-fluid">
                            ...
                            <div class="form-group" id="busquedaPlayas">
                                <div class="col-md-8">
                                    <asp:TextBox ID="txtFiltroNombre" CssClass="form-control input-lg" runat="server"
                                        placeholder="Nombre de playa">
                                    </asp:TextBox>
                                </div>
                                <div class="col-md-4">
                                    <asp:LinkButton runat="server" CssClass="btn-primary btn btn-lg" ID="btnBuscar" Text="Buscar"
                                        OnClick="btnBuscar_Click"></asp:LinkButton>
                                    <asp:LinkButton runat="server" CssClass="btn-success btn btn-lg" ID="btnNuevo" Text="Nueva"
                                        OnClick="btnNuevo_Click" OnClientClick="$('#modificarPlaya').modal({keyboard: false, show: true, backdrop: 'static'});"></asp:LinkButton>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="pnlResultados" runat="server" class="container-fluid" visible="false">
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                Resultados <span style="background-color: white; color: black;" class="badge" id="cantidadPlayas">
                                </span>
                            </div>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Acciones">
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Button ToolTip="Modificar" ID="btnEditar" runat="server" CssClass="btn btn-default"
                                                        CommandArgument="<%# Container.DataItemIndex %>"
                                                        CommandName="Editar" data-toggle="modal" data-target="#modificarPlaya" Text="&#9839;" />

                                                    <asp:Button ToolTip="Eliminar" ID="btnEliminar" runat="server" CssClass="btn btn-default eliminacion"
                                                        CommandArgument="<%# Container.DataItemIndex %>"
