                        ...
                        <div class="form-horizontal " role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 col-md-3 col-lg-3 input-group date horarios" id="dtpDesde">
                                    <asp:TextBox type="time"  runat="server" CssClass="form-control " ID="txtDesde" data-bv-notempty="true" data-bv-notempty-message="Ingrese horario hasta" />
                                ...
                                <div class="col-sm-3 col-md-3 col-lg-3 input-group date horarios" id="dtpHasta">
                                    <asp:TextBox type="time" runat="server" CssClass="form-control " ID="txtHasta" data-bv-notempty="true" data-bv-notempty-message="Ingrese horario hasta" data-bv-greaterthan-inclusive="false" data-bv-greaterthan-message="Horario hasta no puede ser inferior a horario desde." data-bv-greaterthan-value="txtDesde" />
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                </div>
