...
<div>
    <asp:UpdatePanel runat="server" ID="UpdatePanel1">
        <ContentTemplate>
            <asp:LinkButton ID="btnAgregarServicio" runat="server" CssClass="btn btn-md btn-success pull-right" Text="<span class='glyphicon glyphicon-plus'></span>" OnClientClick="mostrarFormularioServicio()" />
        </ContentTemplate>
    </asp:UpdatePanel>
                ...
                <ContentTemplate>
                    <div class="form-horizontal" role="form">
                        ...
                        <div class="form-group pull-right">
                            ...
                            <asp:LinkButton runat="server" ID="btnCancelar" Text="<span class='glyphicon glyphicon-remove-circle'></span>" CssClass="btn btn-lg" ForeColor="Red" BackColor="Transparent" OnClientClick="mostrarFormularioServicio()" />
                        </div>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
